...
/*! This is used when generating CALayer objects, to store the class of the styleable SVGElement that created the CALayer */
#define kSVGElementClassName @"SVGElementClassName"
